    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="./DotacionLista.php" class="btn btn-sm btn-secondary shadow-sm">
                ...
                <div class="card-body">
                    <form id="formIngresarDotacion">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Fecha de Devolución <span class="text-muted"></span></label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="IdFuncionario" name="IdFuncionario" class="form-select" required>
                                        <option value="" disabled selected>Cargando funcionarios...</option>
                                    </select>
                                </div>
