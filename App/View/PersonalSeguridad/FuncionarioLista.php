...
// ── Sedes activas para el modal de edición y los selects de filtro ──
...
// Mapas de apoyo para la tabla y el onclick
$mapSedes         = [];
$mapInstPorSede   = [];
$mapInstIdPorSede = [];
...
$filtros[] = "1 = 1"; // base para siempre tener WHERE
...
// JOIN con sede para poder filtrar por institución
...
<div class="card shadow mb-4">
    <div class="card-header py-3 bg-light d-flex align-items-center justify-content-between">
        ...
        <a href="FuncionarioLista.php" class="btn btn-sm btn-outline-secondary">
