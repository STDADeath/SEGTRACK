        ...
        <div class="card-body px-4 py-5">
            ...
            <div class="bg-white p-3 p-md-4 rounded-4 shadow-sm">
                ...
                <div class="table-responsive">
                    <table id="tablaDispositivosDT" class="table table-hover align-middle text-center mb-0 small">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th class="text-nowrap">Tipo</th>
                                <th class="text-nowrap d-none d-md-table-cell">Marca</th>
                                <th class="text-nowrap d-none d-lg-table-cell">Serial</th>
