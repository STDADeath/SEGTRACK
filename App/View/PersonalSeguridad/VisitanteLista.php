...
<div class="container-fluid px-4 py-4">
            ...
            <form method="get" class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="identificacion" id="identificacion" class="form-control"
                           value="<?= htmlspecialchars($_GET['identificacion'] ?? '') ?>" placeholder="Número de identificación">
                </div>
                <div class="col-md-3">
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control"
                           value="<?= htmlspecialchars($_GET['nombre'] ?? '') ?>" placeholder="Nombre del visitante">
                </div>
                <div class="col-md-3">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-light d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-primary"><?= count($visitantes) ?> registro<?= count($visitantes) !== 1 ? 's' : '' ?></span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id="tablaVisitantesDT" class="table table-bordered table-hover table-striped align-middle text-center" width="100%" cellspacing="0">
