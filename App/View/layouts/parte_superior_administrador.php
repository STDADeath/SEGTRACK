        ...
        <li class="nav-item">
            ...
            <div id="collapseInst" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="../Administrador/Instituto.php">Agregar Institución</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUser" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Administrador/FuncionarioListaADM.php">Lista Funcionarios</a>
                    <div class="collapse-divider"></div>
                    <h6 class="collapse-header">Credenciales:</h6>
                    <a class="collapse-item" href="../Login/Usuario.php">Generar Credenciales</a>
                    <a class="collapse-item" href="../Login/UsuariosLista.php">Lista Usuarios</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseReg" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Administrador/InstitutoLista.php">Registros Instituto</a>
                </div>
            </div>
        </li>
