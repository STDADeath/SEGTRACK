    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUsuarios" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Login/Usuario.php">Registrar Usuario</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseFuncionarios" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Funcionarios:</h6>
                    <a class="collapse-item" href="../Administrador/FuncionariosADM.php">Registrar Funcionario</a>
                    <a class="collapse-item" href="../Administrador/FuncionarioListaADM.php">Lista de Funcionarios</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseInstitutos" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Administrador/Instituto.php">Registrar Instituto</a>
                    <a class="collapse-item" href="../Administrador/Institutolista.php">Lista de Institutos</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSedes" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../Administrador/Sede.php">Registrar Sede</a>
                    <a class="collapse-item" href="../Administrador/Sedelista.php">Lista de Sedes</a>
                </div>
            </div>
        </li>
