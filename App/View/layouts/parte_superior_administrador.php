            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmin1" class="collapse" aria-labelledby="headingAdmin1" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../Administrador/ListarInstituciones.php">Ver Instituciones</a>
                        <a class="collapse-item" href="../Administrador/AgregarInstitucion.php">Agregar Institución</a>
                        <a class="collapse-item" href="../Administrador/EditarInstitucion.php">Editar Institución</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmin2" class="collapse" aria-labelledby="headingAdmin2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../Administrador/ListarSedes.php">Ver Sedes</a>
                        <a class="collapse-item" href="../Administrador/AgregarSede.php">Agregar Sede</a>
                        <a class="collapse-item" href="../Administrador/EditarSede.php">Editar Sede</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmin3" class="collapse" aria-labelledby="headingAdmin3" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../Administrador/ListarUsuarios.php">Ver Usuarios</a>
                        <a class="collapse-item" href="../Administrador/AgregarUsuario.php">Agregar Usuario</a>
                        <a class="collapse-item" href="../Administrador/EditarUsuario.php">Editar Usuario</a>
                        <a class="collapse-item" href="../Administrador/AsignarPermisos.php">Asignar Permisos</a>
